...
export default function Login() {
  ...
  return (
    <div className="min-h-screen grid lg:grid-cols-2 bg-white dark:bg-surface-darker">
      ...
      <div className="flex items-center justify-center p-6 sm:p-12">
        <form onSubmit={submit} className="w-full max-w-sm">
          ...
          <h1 className="font-display text-[26px] font-bold text-ink-900 dark:text-ink-50">Masuk</h1>
