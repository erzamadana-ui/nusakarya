      ...
      <Modal open={!!settle} onClose={() => setSettle(null)} title="Catat Pelunasan Kasbon" size="sm"
        ...
        {settle && (
          <div className="space-y-3">
            <p className="text-caption text-ink-500">Sisa kasbon saat ini: <span className="font-medium text-ink-800 dark:text-ink-100">{rupiah(Number(settle.amount ?? 0) - Number(settle.settled_amount ?? 0))}</span></p>
