...
export default function Lembur() {
 ...
 <div className="mt-4 rounded-md border border-ink-200 overflow-hidden">
 <div className="px-3.5 py-2.5 bg-ink-50 text-caption font-semibold text-ink-600 flex items-center justify-between">
 ...
 Gaji pokok: <span className="text-ink-800 font-medium">{rupiah(basicSalary)}</span> · Upah sejam (÷173): <span className="text-ink-800 font-medium">{rupiah(calc.hourlyWage)}</span>
 ...
 <thead><tr className="border-t border-ink-200 text-ink-400">
 ...
 <tbody>
 {calc.lines.map(l => (
 <tr key={l.jam} className="border-t border-ink-100">
 ...
 <div className="px-3.5 py-2.5 border-t border-ink-200 flex items-center justify-between font-semibold">
 <span className="text-body text-ink-700">Total Estimasi Upah Lembur</span>
 <span className="text-body-l text-ink-900 tabular">{rupiah(calc.total)}</span>
 </div>
