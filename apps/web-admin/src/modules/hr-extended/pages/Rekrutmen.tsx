...
export default function Rekrutmen() {
 ...
 <span className="text-caption font-semibold text-ink-600 uppercase tracking-wide">{stage.label}</span>
 ...
 <p className="font-medium text-body text-ink-800">{a.full_name}</p>
