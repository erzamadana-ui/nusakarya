...
export default function Kompetensi() {
 ...
 columns={[
 { key: 'full_name', header: 'Karyawan', width: '200px', render: r => <div><p className="font-medium text-ink-800">{r.full_name}</p><p className="text-caption text-ink-400">{r.position}</p></div> },
 ...competencies.map(c => ({
