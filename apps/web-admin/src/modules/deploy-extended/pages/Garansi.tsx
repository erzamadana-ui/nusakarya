            ...
            <div>
              ...
              <Section title={<span className="inline-flex items-center gap-2"><Ticket size={15} /> Tiket Gangguan Selama Masa Garansi</span> as any}>
                <div className="grid grid-cols-2 gap-3 mb-3">
                  <div className="p-3 rounded-md bg-ink-50 dark:bg-surface-darker"><p className="text-caption text-ink-400">Jumlah Tiket</p><p className="text-body font-semibold">{num(relatedTickets.length)}</p></div>
                  <div className="p-3 rounded-md bg-ink-50 dark:bg-surface-darker"><p className="text-caption text-ink-400">Estimasi Biaya Ditanggung Perusahaan</p><p className="text-body font-semibold">{rupiah(estCost)}</p></div>
                </div>
