        ...
        {detail && (
          <>
            ...
            {tab === 'lampiran' && (
              <div>
                {can('COMMERCE', 'write') && (
                  <label className="mb-3 inline-flex items-center gap-2 h-9 px-3 rounded-sm border border-ink-200 dark:border-ink-700 text-caption cursor-pointer hover:bg-ink-50 dark:hover:bg-ink-800">
