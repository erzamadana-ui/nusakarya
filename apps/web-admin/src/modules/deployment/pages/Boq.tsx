...
export default function Boq() {
 ...
 <th key={i} className={`px-3 h-11 font-semibold text-caption uppercase text-ink-500 border-b border-ink-200 whitespace-nowrap ${i >= 3 ? 'text-right' : 'text-left'}`}>{h}</th>))}
 </tr>
 </thead>
 <tbody>
