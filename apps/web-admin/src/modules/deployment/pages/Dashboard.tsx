...
export default function Dashboard() {
 ...
 {devBarData.map((d, i) => <Cell key={i} fill={d.deviasi < 0 ? chartColors().danger : chartColors().success} />)}
 </Bar>
 </BarChart>
 </ResponsiveContainer>)}
 </div>
 ...
 <Tooltip formatter={(v: any) => `${num(v, 1)}%`} />
 <Legend />
 <Line type="monotone" dataKey="plan" name="Rencana" stroke={chartColors().neutral} strokeDasharray="4 3" dot={false} strokeWidth={2} />
 <Line type="monotone" dataKey="actual" name="Realisasi" stroke={chartColors().primary} dot={false} strokeWidth={2.5} />
 </LineChart>
 </ResponsiveContainer>)}
 </div>
 </Card>
