              ...
              {chartData.length === 0 ? <p className="text-caption text-ink-400 text-center pt-28">Belum ada laporan progres.</p> : (
                <ResponsiveContainer width="100%" height="100%">
                  <ComposedChart data={chartData}>
                    ...
                    <Legend />
                    <Area yAxisId="right" type="monotone" dataKey="deviasi" name="Deviasi" fill="#F59E0B" fillOpacity={0.18} stroke="#F59E0B" strokeWidth={1} />
                    <Line yAxisId="left" type="monotone" dataKey="plan" name="Rencana" stroke="#64748B" strokeDasharray="4 3" dot={{ r: 2 }} strokeWidth={2} />
                    <Line yAxisId="left" type="monotone" dataKey="actual" name="Realisasi" stroke="#1B8A92" dot={{ r: 2 }} strokeWidth={2.5} />
                  </ComposedChart>
                </ResponsiveContainer>)}
            </div>
          </Card>
