...
export default function Insiden() {
 ...
 {selected.description && <p className="mt-4 text-body text-ink-600"><span className="font-medium text-ink-800">Uraian: </span>{selected.description}</p>}
 {selected.immediate_action && <p className="mt-2 text-body text-ink-600"><span className="font-medium text-ink-800">Tindakan Segera: </span>{selected.immediate_action}</p>}
 </Section>
 )}
