...
export default function Retur() {
 ...
 <Card className="mb-4 p-3 bg-primary-50/50 border-primary-200 flex items-start gap-2.5">
 <Info size={16} className="text-primary-600 mt-0.5 shrink-0" />
 <p className="text-caption text-ink-700 flex-1">Retur yang disetujui perlu diikuti mutasi stok keluar pada modul Inventory agar saldo stok gudang akurat.</p>
 ...
 <div className="ml-auto max-w-xs text-body-l font-semibold flex justify-between border-t border-ink-200 pt-1.5">
