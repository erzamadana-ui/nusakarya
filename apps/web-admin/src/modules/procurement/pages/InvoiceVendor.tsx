...
export default function InvoiceVendor() {
 ...
 <div className="text-center p-3 rounded-md bg-ink-50">
 ...
 <div className="flex items-center justify-between px-3 py-2 rounded-md border border-ink-200">
 ...
 <div className="flex justify-between text-body-l font-semibold border-t border-ink-200 pt-1.5"><span>Total Tagihan</span><span className="tabular">{rupiah(invTotal)}</span></div>
 </div>
