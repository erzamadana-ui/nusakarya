...
export default function Scorecard() {
 ...
 <div className="mt-4 flex items-center justify-between px-3 py-2.5 rounded-md bg-ink-50">
 <span className="text-body text-ink-600">Skor Total (bobot 30/30/20/20)</span>
