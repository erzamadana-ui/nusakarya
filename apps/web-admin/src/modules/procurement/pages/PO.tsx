    ...
    <div>
      ...
      <Drawer open={drawer.open} onClose={() => setDrawer({ open: false })} width="max-w-3xl"
        ...
        <div className="ml-auto max-w-xs space-y-1.5 text-body">
          ...
          <div className="flex justify-between text-body-l font-semibold border-t border-ink-200 dark:border-ink-800 pt-1.5"><span>Total PO</span><span className="tabular">{rupiah(total)}</span></div>
        </div>
      </Drawer>
