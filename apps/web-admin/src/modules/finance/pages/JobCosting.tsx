...
const PIE_COLORS = ['#1B8A92', '#F5A524', '#3AA3AA', '#F59E0B', '#64748B', '#E11D48', '#16A34A']
  ...
  async function openDetail(row: any) {
    ...
    try {
      const jc = await list('job_costs', {
        select: 'id,cost_date,description,amount,cost_category_id,cost_category:cost_categories(name,cost_type)',
