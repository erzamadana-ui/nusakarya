...
export default function Eskalasi() {
 ...
 <td className="py-2 pr-3"><span className="inline-flex items-center justify-center w-6 h-6 rounded-full bg-primary-50 text-primary-700 text-caption font-semibold">{r.level}</span></td>
 ...
 {simResult.map((r: any) => (
 <div key={r.id} className="flex items-center gap-3 p-3 rounded-md bg-ink-50 border border-ink-200">
