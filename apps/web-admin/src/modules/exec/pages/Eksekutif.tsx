...
import { Card, CardHeader, PageHeader, KpiCard, Skeleton, EmptyState, Button, Section, Badge, Modal, Field, Select, Input, Textarea, useToast, Plus } from '@/components/ui'
...
export default function Eksekutif() {
 ...
 const COLORS = { pendapatan: cc.primary, biaya: cc.accent, ar: cc.primary, ap: cc.danger, saldo: cc.info }
...
function RecoItem({ text }: { text: string }) {
 return (
 <li className="flex items-start gap-2.5 text-body text-ink-700">
